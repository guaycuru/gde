	...
	$(document).ready(function() {
		...
		$("input[name='eliminada']").click(function() {
			...
			if(opcao == 1) // Normalmente
				$.post('<?= CONFIG_URL; ?>ajax/disciplina.php', {sigla: '<?= $Disciplina->getSigla(true) ?>', e: '1', a: '0', r: '0'}, function(data) {
					<?php if (!isset($_GET['v'])) { ?>
				...
				$.post('<?= CONFIG_URL; ?>ajax/disciplina.php', {sigla: '<?= $Disciplina->getSigla(true) ?>', e: '1', a: '1', r: '0'}, function(data) {
					<?php if (!isset($_GET['v'])) { ?>
				...
				$.post('<?= CONFIG_URL; ?>ajax/disciplina.php', {sigla: '<?= $Disciplina->getSigla(true) ?>', e: '1', a: '0', r: '1'}, function(data) {
					<?php if (!isset($_GET['v'])) { ?>
				...
				$.post('<?= CONFIG_URL; ?>ajax/disciplina.php', {sigla: '<?= $Disciplina->getSigla(true) ?>', e: '0'}, function(data) {
