var Atualizar_Avisos = function() {
	$.post('../ajax/ax_avisos.php', {}, function(data){
		$("#tab_avisos").html(data);
		});
};

var Atualiza_Avisos_Quantidade = function() {
	$.post('../ajax/aviso.php', {}, function(data){
...
$(document).ready(function() {
	...
	marcarLido = function(id) {
		$.post('../ajax/aviso.php', {id: id, tipo: 'l'}, function(data) {
			Atualiza_Avisos_Quantidade();
	...
	apagarAviso = function(indice) {
		$.post('../ajax/aviso.php', {id: indice, tipo: 'r'}, function(data) {
			Atualiza_Avisos_Quantidade();
